	...
	switch(id) {
		...
		case 0b0000:
			...
			if (parameter == 0b0001){
				...
				else if (get_traversal_status() == MAX_TRAV_SETTING){ status_parameter = 0b0001; } //forwards
				else if (get_traversal_status() == -MAX_TRAV_SETTING){ status_parameter = 0b0010; } //backwards
